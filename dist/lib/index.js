...
function _scanAsync(root, path, depth, options, onFile, onDir) {
    return __awaiter(this, void 0, void 0, function () {
        var excludes, relativePath, name, stat, exception_1, lstat, exception_2, symbolicLink, type, hash, hashAlgorithm, dirTree, _a, children_2, files, exception_3, size, hashEncoding, size, data, exception_4, hashEncoding;
        var _this = this;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [2 /*return*/, output.digest("hex")];
            }
        });
    });
};
var hashPortion = function (path, _a) {
    var _b = _a === void 0 ? { start: 0, end: Infinity } : _a, start = _b.start, end = _b.end;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_c) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var output = crypto_1.createHash("md5");
                    var input = fs_1.createReadStream(path, { start: start, end: end });
